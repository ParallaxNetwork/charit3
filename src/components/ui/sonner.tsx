    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          icon: "group-data-[type=error]:text-red group-data-[type=success]:text-emerald-600 group-data-[type=warning]:text-amber-600 group-data-[type=info]:text-blue-600",
        },
      }}
      {...props}
    />
